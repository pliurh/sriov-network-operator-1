...
var _ = BeforeSuite(func(done Done) {
	...
	os.Setenv("WATCH_NAMESPACE", "openshift-sriov-network-operator")
	...
	defaultConfig.SetNamespace(testNamespace)
	...
	Expect(k8sClient.Create(context.TODO(), defaultConfig)).Should(Succeed())
